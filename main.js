...
// console.log(addSelf)
// console.log(addSelf1)  // Same output
// console.log(addSelf2)  // Same output
// console.log(add) // Same output
...
// // invert numbers positive or negative
...
// // Filter out Words More than 4 Characters
...
//     console.log(`##############`)
//     return acc+current 
// }, 5)  // 5 here is initial value can be added to start with before the array numbers
// console.log(add)
...
//         allLis.forEach(function(ele){   // Remove active class from all Elements
//             ele.classList.remove("active")
//         })
//         this.classList.add("active") // Add active class to element clicked
//         allDivs.forEach(function(ele){  // Hide all Divs
